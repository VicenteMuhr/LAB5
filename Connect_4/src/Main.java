...
public class Main {
    ...
    public static class ConnectFour {
        ...
        public GameState isGameOver() {
            if (checkWin('X')) {return GameState.X_WINS;}
            if (checkWin('O')) {return GameState.O_WINS;}
    ...
    public static class Game {
        ...
        public String play() {
            ...
            while (status.equals("En progreso")) {
                ...
                if (gameState == ConnectFour.GameState.X_WINS) {
                    status = "Victoria";
                    winnerPlayerName = playerNameA;
                    System.out.println("\n¡" + playerNameA + " gana ");
                    scoreboard.addGameResult(playerNameA, playerNameB, false);
                } else if (gameState == ConnectFour.GameState.O_WINS) {
                    status = "Victoria";
